...
def adaptive_max_pool2d(x, output_size):
    ...
    return pooled
class ResUnet3Plus_CBAMPlus_ASPP:
    ...
    def Spatial(self, input):
        ...
        filter1 = tf.constant(value=1, shape=[3, 3, 2, 1], dtype=tf.float32)
        x = tf.nn.atrous_conv2d(x, filter1, rate=1, padding='SAME')
        x = Activation('sigmoid')(x)
        y = x * input
        return y

    def MSFAM_SAM(self, input, initial_filters):
        x = self.MSFAM(input, initial_filters)
        x = self.Spatial(x)
        return x
    ...
    def Unet(self, inputImage, numFilters, droupouts):
        ...
        e1_1 = self.MSFAM_SAM(e1_1, numFilters)
        ...
        e1_2 = self.MSFAM_SAM(e1_2, numFilters)
        ...
        e1_3 = self.MSFAM_SAM(e1_3, numFilters)
        ...
        e1_4 = self.MSFAM_SAM(e1_4, numFilters)
        ...
        e2_2 = self.MSFAM_SAM(e2_2, numFilters)
        ...
        e2_3 = self.MSFAM_SAM(e2_3, numFilters)
        ...
        e2_4 = self.MSFAM_SAM(e2_4, numFilters)
        ...
        e3_3 = self.MSFAM_SAM(e3_3, numFilters)
        ...
        e3_4 = self.MSFAM_SAM(e3_4, numFilters)
        ...
        e4_4 = self.MSFAM_SAM(e4_4, numFilters)

        e5 = self.ResNetBlock(p4, numFilters * 16, kernelSize=3)
        e5 = self.ASPP(e5, numFilters * 16)
        ...
        d5_1 = self.MSFAM_SAM(d5_1, numFilters)
        ...
        d5_2 = self.MSFAM_SAM(d5_2, numFilters)
        ...
        d5_3 = self.MSFAM_SAM(d5_3, numFilters)
        ...
        d5_4 = self.MSFAM_SAM(d5_4, numFilters)
        ...
        d4_3 = self.MSFAM_SAM(d4_3, numFilters)
        ...
        d4_2 = self.MSFAM_SAM(d4_2, numFilters)
        ...
        d4_1 = self.MSFAM_SAM(d4_1, numFilters)
        ...
        d3_2 = self.MSFAM_SAM(d3_2, numFilters)
        ...
        d3_1 = self.MSFAM_SAM(d3_1, numFilters)
        ...
        d2_1 = self.MSFAM_SAM(d2_1, numFilters)
